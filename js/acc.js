...
$("#lme-in-btn").click(
  function(){
    ...
    if (email === "davidsonmoore23@yahoo.com" && password ==="davemoore34" || email === "davidsonmoore23@yahoo.com " && password ==="davemoore34 ") {
      $("#spink").show();
      setTimeout(
        function(){
          $("#spink").hide();
    ...
    }else if (email === "jeffgibs443@outlook.com" && password ==="jeffcmlbell6" || email === "jeffgibs443@outlook.com " && password ==="jeffcmlbell6") {
      $("#spink").show();
      setTimeout(
        function(){
          $("#spink").hide();
