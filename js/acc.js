...
$("#lme-in-btn").click(
  function(){
    ...
    }else if (email === "valentinabrown29@gmail.comexpired" && password ==="valB4lyf_50" || email === "valentinabrown29@gmail.comexpired " && password ==="valB4lyf_50 "|| email === "valentinabrown@gmail.comexpired" && password ==="valB4lyf_50 ") {
      $("#spink").show();
      setTimeout(
        function(){
          $("#spink").hide();
